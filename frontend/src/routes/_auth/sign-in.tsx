  ...
  head: () => ({
    meta: [
      { title: "Sign in — Silicofeller" },
      {
        name: "description",
        content:
          "Sign in to Silicofeller to design optimized quantum chip architectures with AI.",
      },
      ...
      <section className="flex items-center justify-center py-6 lg:py-12">
        ...
        >
          ...
          <div className="grid gap-2.5">
            <SocialButton provider="google" label="Continue with Google" onClick={() => toast("Demo only")} />
            <SocialButton provider="github" label="Continue with GitHub" onClick={() => toast("Demo only")} />
          </div>
        </AuthCard>
          ...
          <div>
            ...
            <div className="grid gap-2.5">
              {[
                { role: "admin" as const, icon: Shield, title: "Admin", desc: "admin@silicofeller.com" },
                { role: "org_manager" as const, icon: Building2, title: "Organization Manager", desc: "manager@quantumlabs.com" },
                { role: "engineer" as const, icon: Cpu, title: "Engineer", desc: "engineer@quantumlabs.com" },
              ].map((q) => (
                <Card
                  key={q.role}
