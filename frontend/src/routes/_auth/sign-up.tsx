      ...
      <section className="flex items-center justify-center py-6 lg:py-12">
        ...
        >
          <form onSubmit={onSubmit} className="space-y-4" noValidate>
            ...
            <div className="space-y-2.5 pt-1">
              <label className="flex items-start gap-2.5 text-sm text-muted-foreground">
                ...
                <span>
                  I agree to the{" "}
                  <a href="#" className="text-foreground underline">Terms of Service</a> and{" "}
                  <a href="#" className="text-foreground underline">Privacy Policy</a>.
                </span>
              </label>
              {errors.terms && (
                <p className="pl-7 text-xs text-destructive" role="alert">{errors.terms}</p>
              )}
              <label className="flex items-start gap-2.5 text-sm text-muted-foreground">
                <Checkbox
                  id="updates"
          ...
          <div className="grid gap-2.5">
            <SocialButton provider="google" label="Sign up with Google" onClick={() => toast("Demo only")} />
            <SocialButton provider="github" label="Sign up with GitHub" onClick={() => toast("Demo only")} />
          </div>
        </AuthCard>
      </section>
    </div>
